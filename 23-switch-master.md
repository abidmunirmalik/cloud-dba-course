...
### ON ON-PREM REPLICA
```sql
CAHANGE REPLICATION SOURCE TO SOURCE_HOST='prod.cquael8kyh30.us-east-1.rds.amazonaws.com', SOURCE_USER='replication_admin', SOURCE_PASSWORD='P@ssw0rd123', SOURCE_SSL=1, SOURCE_AUTO_POSITION=1;
START REPLICA;
SHOW REPLICA STATUS\G
```
